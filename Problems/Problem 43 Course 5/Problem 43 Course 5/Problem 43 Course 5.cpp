// Problem 43 Course 5.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int CountOdd(int Arr[100], int Length)
{
    ...
    for (int i = 0;i < Length;i++)
    {
        ...
        if (CheckType(Arr[i]) == enType::Even)
        {
...
int main()
{
    ...
    cout << "\nEven Numbers count: " << CountOdd(Arr, Length) << "\n";
